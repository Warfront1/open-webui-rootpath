# For Developers of open-webui-rootpath

For anything other than our additional rootpath support, please refer to the [open-webui](https://github.com/open-webui/open-webui) repo.
